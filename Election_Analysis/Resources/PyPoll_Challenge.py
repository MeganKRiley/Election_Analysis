...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (countyvotes > highest_turnout_count) and (countyvote_percentage > highest_turnout_percentage):
            highest_turnout_count = countyvotes
    ...
    Highest_Turnout_County_Summary = (
        f"-------------------------\n"
        f"Winner: {highest_turnout_county}\n"
        f"Winning Vote Count: {highest_turnout_count:,}\n"
        f"Winning Percentage: {highest_turnout_percentage:.1f}%\n"
        f"-------------------------\n")
